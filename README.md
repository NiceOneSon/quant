...
| `dim_universe_history` | `sk_id = hash(universe, symbol, valid_from)` | 유니버스 멤버십 이력. valid_to=null 이면 현재 편입 중 |
...
make dbt-build   # seed + run + test + Evidence 캐시 클리어 (PASS=87)
